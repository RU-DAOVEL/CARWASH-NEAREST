...
uses
  FMX.Types, FMX.Controls, FMX.StdCtrls, FMX.TextLayout, System.UITypes,
  FMX.ListView, FMX.FontGlyphs, FMX.Objects, FMX.Dialogs
{$IFDEF ANDROID}
...
const
  aStyledSettings: TStyledSettings =
    [ { TStyledSetting.Size, TStyledSetting.FontColor, TStyledSetting.Style, TStyledSetting.Other } ];
var
  aPresentedClass: TPresentedTextControl;
  aEdit: TEdit;
  aTextClass: TTextControl;
  aTextControlClass: TText;
  aListClass: TListView;
...
begin
  ...
  begin
    aListClass := aControl as TListView;
    aListClass.ItemAppearanceObjects.ItemObjects.Text.Font.Family :=
      FontAwesomeName;
    aListClass.ItemAppearanceObjects.ItemObjects.Detail.Font.Family :=
      FontAwesomeName;
  end
