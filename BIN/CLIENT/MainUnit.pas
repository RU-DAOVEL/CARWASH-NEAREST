...
uses
  ...
  FMX.StdCtrls, FMX.Controls.Presentation, FMX.ListView.Types, FMX.ListView.Appearances,
  FMX.ListView.Adapters.Base, FMX.ListView, System.Rtti, System.Bindings.Outputs,
  FMX.Bind.Editors, Data.Bind.EngExt, FMX.Bind.DBEngExt, Data.Bind.Components,
  Data.Bind.DBScope, FMX.MultiView, FMX.Effects, FMX.Layouts, FMX.Objects, FMX.ListBox,
...
type
  TForm3 = class(TForm)
    ...
    img1: TImage;
    lvUsluga: TListView;
    bs_Services: TBindSourceDB;
    LinkListControlToField1: TLinkListControlToField;
    bs_Class: TBindSourceDB;
    ...
    procedure lvWashListUpdateObjects(const Sender: TObject; const AItem: TListViewItem);
  private
...
uses
  ClientModuleUnit, FontAwesome;

procedure TForm3.lvWashListUpdateObjects(const Sender: TObject; const AItem: TListViewItem);
var
  ItemName, ItemAdress, ItemStatus, ItemMapStatus, ItemLatitude, ItemLongitude, ItemDistancy, ItemTime, ItemImgTime, ItemTStar, ItemStar, ItemInfo: TListItemText;
...
begin
  ...
  if (ItemLatitude <> nil) and (ItemLongitude <> nil) and (ItemLatitude.Text <> '') and (ItemLongitude.Text <> '') and (ItemDistancy <> nil) then
  begin
    ItemDistancy.Text := FormatFloat('≈ 0.00 км', 25 { WebGMaps.Distance(ItemLatitude.Text.ToDouble, ItemLongitude.Text.ToDouble, lat, lon) } );
  end;
